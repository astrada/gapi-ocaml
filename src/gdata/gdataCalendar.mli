...
sig
  module Entry :
  sig
    type t = GdataComments.Make(Link).Entry.t = {
      ce_etag : string;
      ce_authors : GdataAtom.atom_author list;
      ce_content : GdataAtom.atom_content;
      ce_contributors : GdataAtom.atom_contributor list;
  ...
  type comments = GdataComments.Make(Link).comments (*
    OCaml 3.11 does not accept this equivalence (TODO: find a workaround)
  = {
    c_countHint : int;
    c_href : string;
    c_readOnly : bool;
