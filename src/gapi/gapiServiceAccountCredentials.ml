...
let parse x = function
  | GapiCore.AnnotatedTree.Leaf
      ...
      { x with _type = v }
  | GapiCore.AnnotatedTree.Leaf
      ({ GapiJson.name = "project_id"; data_type = GapiJson.Scalar }, `String v)
    ->
      { x with project_id = v }
  | GapiCore.AnnotatedTree.Leaf
  ...
  | GapiCore.AnnotatedTree.Leaf
      ({ GapiJson.name = "private_key"; data_type = GapiJson.Scalar }, `String v)
    ->
  ...
  | GapiCore.AnnotatedTree.Leaf
      ({ GapiJson.name = "client_id"; data_type = GapiJson.Scalar }, `String v)
    ->
      { x with client_id = v }
  | GapiCore.AnnotatedTree.Leaf
      ({ GapiJson.name = "auth_uri"; data_type = GapiJson.Scalar }, `String v)
    ->
      { x with auth_uri = v }
  | GapiCore.AnnotatedTree.Leaf
      ({ GapiJson.name = "token_uri"; data_type = GapiJson.Scalar }, `String v)
    ->
      { x with token_uri = v }
  | GapiCore.AnnotatedTree.Leaf
      ( {
