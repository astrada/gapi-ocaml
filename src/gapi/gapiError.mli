...
module SingleError : sig
  type t = {
    domain : string;  (** The domain in which the error occured *)
    reason : string;  (** The reason the error was thrown *)
    message : string;  (** The error message *)
    locationType : string;  (** Type of the location *)
    location : string;  (** Location where the error was thrown *)
    extendedHelp : string;
  }
...
module RequestError : sig
  type t = {
    errors : SingleError.t list;  (** Contains a list of all errors *)
