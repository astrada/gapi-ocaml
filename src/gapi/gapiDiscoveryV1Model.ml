...
struct
  ...
  let enumDeprecated = {
    GapiLens.get = (fun x -> x.enumDeprecated);
    GapiLens.set = (fun v x -> { x with enumDeprecated = v });
  }
  let pattern = {
  ...
  let deprecated = {
    GapiLens.get = (fun x -> x.deprecated);
    GapiLens.set = (fun v x -> { x with deprecated = v });
  }
  let properties = {
  ...
  let rec render_content x = 
     [
      ...
      GapiJson.render_array "enumDeprecated" (GapiJson.render_bool_value "") x.enumDeprecated;
      ...
      GapiJson.render_bool_value "deprecated" x.deprecated;
  ...
  let rec parse x = function
    ...
    | GapiCore.AnnotatedTree.Leaf
      ...
      { x with minimum = v }
    | GapiCore.AnnotatedTree.Node
        ({ GapiJson.name = "enumDeprecated"; data_type = GapiJson.Array },
        cs) ->
      GapiJson.parse_collection
        (fun x' -> function
          | GapiCore.AnnotatedTree.Leaf
    ...
    | GapiCore.AnnotatedTree.Leaf
        ({ GapiJson.name = "deprecated"; data_type = GapiJson.Scalar },
        `Bool v) ->
      { x with deprecated = v }
    | GapiCore.AnnotatedTree.Node
...
struct
  ...
  let apiVersion = {
    GapiLens.get = (fun x -> x.apiVersion);
    GapiLens.set = (fun v x -> { x with apiVersion = v });
  }
  ...
  let rec render_content x = 
     [
      ...
      GapiJson.render_string_value "apiVersion" x.apiVersion;
  ...
  let rec parse x = function
    ...
    | GapiCore.AnnotatedTree.Node
      ...
      GapiJson.parse_children
        ...
        cs
    | GapiCore.AnnotatedTree.Leaf
        ({ GapiJson.name = "apiVersion"; data_type = GapiJson.Scalar },
        `String v) ->
      { x with apiVersion = v }
    | GapiCore.AnnotatedTree.Leaf
...
struct
  ...
  struct
    ...
    let endpointUrl = {
      GapiLens.get = (fun x -> x.endpointUrl);
      GapiLens.set = (fun v x -> { x with endpointUrl = v });
    }
    ...
    let rec render_content x = 
       [
        ...
        GapiJson.render_bool_value "deprecated" x.deprecated;
        GapiJson.render_string_value "description" x.description;
        GapiJson.render_string_value "endpointUrl" x.endpointUrl;
    ...
    let rec parse x = function
      ...
      | GapiCore.AnnotatedTree.Leaf
        ...
        { x with description = v }
      | GapiCore.AnnotatedTree.Leaf
          ({ GapiJson.name = "endpointUrl"; data_type = GapiJson.Scalar },
          `String v) ->
        { x with endpointUrl = v }
      | GapiCore.AnnotatedTree.Node
        ({ GapiJson.name = ""; data_type = GapiJson.Object },
        cs) ->
        GapiJson.parse_children parse empty (fun x -> x) cs
      | e ->
        GapiJson.unexpected "GapiDiscoveryV1Model.Endpoints.parse" e x
  ...
  let endpoints = {
    GapiLens.get = (fun x -> x.endpoints);
    GapiLens.set = (fun v x -> { x with endpoints = v });
  }
  let labels = {
    GapiLens.get = (fun x -> x.labels);
    GapiLens.set = (fun v x -> { x with labels = v });
  ...
  let rec render_content x = 
     [
      ...
      GapiJson.render_array "endpoints" Endpoints.render x.endpoints;
      GapiJson.render_array "labels" (GapiJson.render_string_value "") x.labels;
  ...
  let rec parse x = function
    ...
    | GapiCore.AnnotatedTree.Leaf
      ...
      { x with rootUrl = v }
    | GapiCore.AnnotatedTree.Node
        ({ GapiJson.name = "endpoints"; data_type = GapiJson.Array },
        cs) ->
      GapiJson.parse_collection
        (fun x' -> function
          | GapiCore.AnnotatedTree.Node
