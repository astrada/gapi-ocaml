...
let test_parse_dataset_list () =
  let dataset_list_json =
    Json_io.load_json "test_data/test_bigquery_dataset_list.json" in
...
let test_parse_dataset () =
  let dataset_json =
    Json_io.load_json "test_data/test_bigquery_dataset.json" in
...
let test_parse_getqueryresults () =
  let queryresult_json =
    Json_io.load_json "test_data/test_bigquery_getqueryresults.json" in
...
let test_parse_job_list () =
  let job_list_json =
    Json_io.load_json "test_data/test_bigquery_job_list.json" in
...
let test_parse_queryrequest () =
  let queryrequest_json =
    Json_io.load_json "test_data/test_bigquery_queryrequest.json" in
...
let test_parse_queryresult () =
  let queryresult_json =
    Json_io.load_json "test_data/test_bigquery_queryresult.json" in
  let tree = GapiJson.json_to_data_model queryresult_json in
...
let test_parse_project_list () =
  let project_list_json =
    Json_io.load_json "test_data/test_bigquery_project_list.json" in
...
let test_parse_tabledata_list () =
  let tabledata_list_json =
    Json_io.load_json "test_data/test_bigquery_tabledata_list.json" in
...
let test_parse_table () =
  let table_json =
    Json_io.load_json "test_data/test_bigquery_table.json" in
...
let test_parse_table_list () =
  let table_list_json =
    Json_io.load_json "test_data/test_bigquery_table_list.json" in
