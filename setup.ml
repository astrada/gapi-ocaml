...
(* OASIS_START *)
(* DO NOT EDIT (digest: f81b10de50a51a16b3d5a8df68178f6c) *)
(*
...
# 21 "/home/alex/.odb/install-oasis/oasis-0.2.1~alpha1/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$testSuite", []))];
     ...
     doc =
       [
          ("gdata", OCamlbuildDocPlugin.doc_build "./");
          ("gapi", OCamlbuildDocPlugin.doc_build "./")
       ];
     ...
     clean_doc =
       [
          ("gdata", OCamlbuildDocPlugin.doc_clean "./");
          ("gapi", OCamlbuildDocPlugin.doc_clean "./")
       ];
     distclean = [];
     distclean_test =
       [
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/astrada/gapi-ocaml";
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_internal_modules = ["GdataUtils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = [];
                      });
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "src/examples/auth";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "gapi"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title =
                        "API reference for Google Data Protocol client library (gdata)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/api";
                      doc_title =
                        "API reference for Google APIs client library (gapi)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [("doc/style.css", None)];
