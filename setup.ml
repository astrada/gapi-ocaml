...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0155b7187563c403f80640cd80799724) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("netstring",
                               Some (OASISVersion.VGreaterEqual "3.5.1"));
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "gapi-ocaml";
                           FindlibPackage ("monad-custom", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "serviceGenerator.ml"
                   });
               Executable
                 ({
                     cs_name = "oauth2Flow";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Z\152\030T\243\173\005\229\1732\176u\0027\186s";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
